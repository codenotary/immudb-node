...
proto.google.protobuf.MethodDescriptorProto.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    clientStreaming: (f = jspb.Message.getBooleanField(msg, 5)) == null ? undefined : f,
    serverStreaming: (f = jspb.Message.getBooleanField(msg, 6)) == null ? undefined : f
  };
...
proto.google.protobuf.FileOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    javaMultipleFiles: (f = jspb.Message.getBooleanField(msg, 10)) == null ? undefined : f,
    javaGenerateEqualsAndHash: (f = jspb.Message.getBooleanField(msg, 20)) == null ? undefined : f,
    javaStringCheckUtf8: (f = jspb.Message.getBooleanField(msg, 27)) == null ? undefined : f,
    optimizeFor: jspb.Message.getFieldWithDefault(msg, 9, 1),
    goPackage: (f = jspb.Message.getField(msg, 11)) == null ? undefined : f,
    ccGenericServices: (f = jspb.Message.getBooleanField(msg, 16)) == null ? undefined : f,
    javaGenericServices: (f = jspb.Message.getBooleanField(msg, 17)) == null ? undefined : f,
    pyGenericServices: (f = jspb.Message.getBooleanField(msg, 18)) == null ? undefined : f,
    deprecated: (f = jspb.Message.getBooleanField(msg, 23)) == null ? undefined : f,
    ccEnableArenas: (f = jspb.Message.getBooleanField(msg, 31)) == null ? undefined : f,
...
proto.google.protobuf.MessageOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    messageSetWireFormat: (f = jspb.Message.getBooleanField(msg, 1)) == null ? undefined : f,
    noStandardDescriptorAccessor: (f = jspb.Message.getBooleanField(msg, 2)) == null ? undefined : f,
    deprecated: (f = jspb.Message.getBooleanField(msg, 3)) == null ? undefined : f,
...
proto.google.protobuf.FieldOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lazy: (f = jspb.Message.getBooleanField(msg, 5)) == null ? undefined : f,
    deprecated: (f = jspb.Message.getBooleanField(msg, 3)) == null ? undefined : f,
    weak: (f = jspb.Message.getBooleanField(msg, 10)) == null ? undefined : f,
    uninterpretedOptionList: jspb.Message.toObjectList(msg.getUninterpretedOptionList(),
    proto.google.protobuf.UninterpretedOption.toObject, includeInstance)
  };
...
proto.google.protobuf.EnumValueOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    deprecated: (f = jspb.Message.getBooleanField(msg, 1)) == null ? undefined : f,
    uninterpretedOptionList: jspb.Message.toObjectList(msg.getUninterpretedOptionList(),
    proto.google.protobuf.UninterpretedOption.toObject, includeInstance)
  };
...
proto.google.protobuf.ServiceOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    deprecated: (f = jspb.Message.getBooleanField(msg, 33)) == null ? undefined : f,
    uninterpretedOptionList: jspb.Message.toObjectList(msg.getUninterpretedOptionList(),
    proto.google.protobuf.UninterpretedOption.toObject, includeInstance)
  };
