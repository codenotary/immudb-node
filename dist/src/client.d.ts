...
declare class ImmudbClient {
    ...
    createDatabase({ databasename }: messages.Database.AsObject): Promise<empty.Empty | undefined>;
    useDatabase({ databasename }: messages.Database.AsObject): Promise<messages.UseDatabaseReply.AsObject | undefined>;
    set({ key, value }: messages.KeyValue.AsObject): Promise<messages.TxMetadata.AsObject | undefined>;
    get({ key }: messages.Key.AsObject): Promise<messages.Entry.AsObject | undefined>;
    ...
    setReferenceAt(params: messages.Entry.AsObject): Promise<messages.TxMetadata.AsObject | undefined>;
    verifiedSetReference(): Promise<void>;
    verifiedSetReferenceAt(): Promise<void>;
    setAll({ kvsList }: messages.SetRequest.AsObject): Promise<messages.TxMetadata.AsObject | undefined>;
    execAll({ operationsList }: messages.ExecAllRequest.AsObject): Promise<messages.TxMetadata.AsObject | undefined>;
    getAll({ keysList, sincetx }: messages.KeyListRequest.AsObject): Promise<messages.Entries.AsObject | undefined>;
    verifiedSet({ key, value }: messages.KeyValue.AsObject): Promise<messages.TxMetadata.AsObject | undefined>;
    verifiedGet({ key }: messages.Key.AsObject): Promise<messages.Entry.AsObject | undefined>;
    ...
    verifiedTxById({ tx }: messages.TxRequest.AsObject): Promise<messages.Tx.AsObject | undefined>;
    txScan(params: messages.TxScanRequest.AsObject): Promise<messages.TxList.AsObject | undefined>;
    cleanIndex(): Promise<empty.Empty | undefined>;
}
